...
export interface MemberInfo {
  ...
  aadhaar: string;
  pan: string;
  /** Director Identification Number (companies) — MCA-fetched. */
  din?: string;
}
...
export interface EntityMeta {
  ...
  members: string[];
  /** Members authorised to operate the account (subset of `members`). */
...
export const ENTITY_META: Partial<Record<EntityId, EntityMeta>> = {
  ...
  ltd: {
    legalName: 'Shri Shakti Properties and BMS',
    constitution: 'Private Limited Company',
    memberNoun: 'Directors',
    memberNounSingular: 'Director',
    members: ['Ravi Kumar', 'Rahul Mishra', 'Anjali Sharma'],
    authorisedSignatories: ['Ravi Kumar', 'Rahul Mishra'],
    pan: 'AAGCF5123R',
    cin: 'U23941GJ2016PTC181035',
    dateOfIncorporation: '14 Mar 2016',
    registeredOffice: 'Survey No. 264, Village Navinal, Ta. Mundra, Dist. Kutch, Gujarat 370421',
    roc: 'RoC-Ahmedabad',
    status: 'Active',
    membersInfo: [
      { name: 'Ravi Kumar', address: '12 Gandhipuram, Coimbatore, TN 641001', dob: '14 Mar 1988', aadhaar: 'xxxx xxxx 1234', pan: 'ABCPK1234A', din: '09876543' },
      { name: 'Rahul Mishra', address: '48 Indiranagar, Bengaluru, KA 560001', dob: '22 Jul 1991', aadhaar: 'xxxx xxxx 5678', pan: 'XYZPM5678B', din: '08765432' },
      { name: 'Anjali Sharma', address: '9 Koregaon Park, Pune, MH 411001', dob: '09 Nov 1985', aadhaar: 'xxxx xxxx 9012', pan: 'LMNPS9012C', din: '07654321' },
    ],
  },
};
...
/** Members authorised to operate the account — defaults to the first member. */
export function authorisedSignatoriesFor(entity?: string): string[] {
  const meta = ENTITY_META[entity as EntityId];
  return meta?.authorisedSignatories ?? membersFor(entity).slice(0, 1);
}
